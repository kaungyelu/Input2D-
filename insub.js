...
const messages = [
    { text: "မဂ်လာပါ ခင်ဗျာ", duration: 2000, type: "short" },
    { text: "2Dစာရင်းအင်းများကို", duration: 3000, type: "medium" },
    { text: "လွယ်ကူမြန်ဆန်စွာ လုပ်ဆောင်နိုင်ရန်", duration: 4000, type: "long" },
    { text: "KK-user မှ ဖန်တီးထားခြင်းဖြစ်ပါသည်", duration: 5000, type: "long" },
    { text: "ယခု Webappအား အသုံးပြုရန်", duration: 4000, type: "medium" },
    { text: "သုံးသိန်းငါးသောင်း ကျပ် (၃၅၀၀၀၀ကျပ်)တိတိ ကျသင့်ပါမည်", duration: 10000, type: "long" },
    { text: "Server ကြေးပေးသွင်းရန်မှာ", duration: 5000, type: "medium" },
    { text: "အလုပ်ပေါ်မူတည်ပါတယ် Data မများပါက မလိုအပ်နိုင်", duration: 7000, type: "long" },
    { text: "လိုအပ်လာလျင်လည်း ပြောကြားပေးပါမည်", duration: 5000, type: "medium" }
];
...
async function startTypingAnimation() {
    ...
    // စာကြောင်းအရှည်အလိုက် ကြာချိန်သတ်မှတ် (အနည်းဆုံး 2000ms)
    const displayTime = Math.max(message.duration, 2000);
